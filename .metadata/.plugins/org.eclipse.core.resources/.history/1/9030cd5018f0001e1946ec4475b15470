...
@Api(value = "Creat farmer data Api")
public class Farmerconrollerimpl implements Farmercontroller {
	...
	public BaseResponse creatfarmer(
			@RequestBody @ApiParam(value = "creatadminRequest", required = true) FarmerRequest farmerRequest,
			HttpServletRequest request, HttpServletResponse response) {

		return farmerHandler.creatfarmer(farmerRequest);
	}
}
